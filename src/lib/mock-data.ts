...
export const ROLES: UserRole[] = ["Store Manager", "IT Managers", "CEO", "Director", "Finance Manager", "HR/Admin", "Field Operational Officer", "Media & Communications Officer"];
...
export const USERS: User[] = [
    ...
    { id: 8, username: 'media', password: '123', role: 'Media & Communications Officer' },
];
