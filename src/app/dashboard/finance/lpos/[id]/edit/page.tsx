...
import { z } from "zod";
import { ArrowLeft, Save, FileText, PlusCircle, Trash2, Calendar as CalendarIcon } from "lucide-react";
...
export default function EditLpoPage() {
  ...
  if (!lpo) {
    return (
      <div className="p-4 sm:p-6 lg:p-8">
        <Card>
          <CardHeader>
            <CardTitle>LPO Not Found</CardTitle>
            <CardDescription>The requested LPO could not be found.</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  function onSubmit(data: LpoFormValues) {
    ...
    toast({
      title: "LPO Updated",
      description: `LPO ${lpo?.number} has been successfully updated.`,
    });
  }
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>
                    Update the details for this Local Purchase Order.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This action will update the LPO details.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
