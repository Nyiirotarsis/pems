          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <CardContent className="space-y-4">
                <div className="flex items-center gap-4 mb-6">
                    {asset.imageURL ? (
                        <Image src={asset.imageURL} alt={asset.itemName} width={100} height={100} className="rounded-md border"/>
                    ) : (
                        <div className="w-[100px] h-[100px] flex items-center justify-center bg-muted rounded-md border">
