...
const quickActions = [
  { id: "users", title: "Add User / Role", icon: UserPlus, href: "/dashboard/admin/users" },
  { id: "devices", title: "Device Authorization", icon: Smartphone, href: "/dashboard/assets/scanning-devices" },
  { id: "registry", title: "Event Registry", icon: Camera, href: "/dashboard/admin/event-registry" },
  { id: "scan", title: "Run Security Scan", icon: ShieldCheck, href: "/dashboard/admin/security" },
  { id: "logs", title: "Review Logs", icon: FileClock, href: "/dashboard/admin/security" },
  { id: "backup", title: "Trigger Backup", icon: ListRestart, href: "/dashboard/admin/systems" },
];
